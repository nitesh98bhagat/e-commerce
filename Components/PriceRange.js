      ...
      <div className="mb-4">
        ...
        <div className="range-input relative  ">
          <input
            ...
            max={max}
            value={minValue}
            className="range-min absolute w-full  -top-1  h-1   bg-transparent  appearance-none "
          />
          ...
          <input
            ...
            max={max}
            value={maxValue}
            className="range-max absolute w-full  -top-1 h-1  bg-transparent appearance-none  "
          />
        </div>
      </div>
    </div>
