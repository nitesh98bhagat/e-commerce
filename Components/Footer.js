  ...
  return (
    <footer className="text-center lg:text-left border-t text-gray-600">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-8 items-start justify-items-center">
          <div className="">
            <h6
              className="
            uppercase
          ...
          "
            ...
            <address>
              BA-22, Desh Bandhu Nagar, Baguiati, Kolkata, India
              <br />
              pin: 700059
            </address>
          </div>
      ...
      <div className="flex flex-col items-center p-3 bg-slate-50">
        <span>© 2021 Copyright BuyZone.com</span>

        <a className="text-gray-600 font-semibold text-xs ">
          Website Developed by Nitesh Bhagat
        </a>
      </div>
    </footer>
  );
